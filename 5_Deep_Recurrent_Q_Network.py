...
class DRQN:
	...
	def train(self, replay_memory):
		...
		Q_batch = self.output_target.eval(feed_dict = {self.input_target: next_state_batch,self.rnn_batch_size_target: self.Num_batch,self.rnn_step_size_target: self.step_size})
		...
		_, self.loss = self.sess.run([self.train_step, self.loss_train], feed_dict = {self.action_target: action_in, self.y_target: y_batch, self.input: state_batch,self.rnn_batch_size: self.Num_batch,self.rnn_step_size: self.step_size})
